				...
				<div class="col-lg-3 col-md-6 footer-col">
					<div class="footer-box subscribe">
						...
						<form action="#" type="POST">
							<input type="email" placeholder="Email" id="newsletterEmail">
							<button id="newsletterButton" type="submit"><i class='bx bx-paper-plane'></i> </button>
						</form>
					</div>
				</div>
			</div>
	...
	<div class="copyright">
        ...
        </script>  - <a href="#">Medipropharma</a>,  Tous droits réservés.<br>
					</p>
				</div>
